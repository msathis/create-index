...
exports.default = function (directoryPaths) {
  ...
  if (options.updateIndex) {
    ...
    (0, _log2.default)('Recursive:', options.ignoreUnsafe ? _chalk2.default.green('true') : _chalk2.default.red('false'));
  ...
  _lodash2.default.forEach(sortedDirectoryPaths, directoryPath => {
    ...
    const siblings = (0, _readDirectory2.default)(directoryPath, { silent: options.ignoreUnsafe });
